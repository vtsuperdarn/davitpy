...
C
      ...
      CHARACTER*30 FNM
      INTEGER NPTS
      DIMENSION aLAT(1000),aLON(1000)     ! Edit SdL
      DIMENSION aD(1000),aS(1000),aH(1000)     ! Edit SdL
      DIMENSION aX(1000),aY(1000),aZ(1000),aF(1000)     ! Edit SdL
Cf2py intent(in) ITYPE
Cf2py intent(in) DATE
Cf2py intent(in) ALT
Cf2py intent(in) XLTI,XLTF,XLTD
Cf2py intent(in) XLNI,XLNF,XLND
Cf2py intent(in) IFL
Cf2py intent(OUT) aD,aS,aH,aX,aY,aZ,aF
