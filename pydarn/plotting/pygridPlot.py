...
def plotPygrid(sTime=None,eTime=None,plot='all',rads=None,hemi='north',interval=60,grid=0,vmax=500,vwidth=.2):
...
def drawPygridMap(myFig,myGrid,grid=0):
  ...
  *******************************
  ...
  myMap = utils.mapObj(boundinglat=40, lon_0=0.,grid=False,fillContinents='none',fillLakes='none')
